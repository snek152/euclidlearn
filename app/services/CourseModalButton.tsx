...
export function CourseLinkButton({ course }: CourseModalButtonProps) {
  return (
    ...
    >
      ...
      <span className="absolute md:group-hover:w-full transition-all top-0 left-0 md:group-hover:opacity-25 z-0 duration-200 bg-gradient-to-r from-white to-red rounded-full h-full w-full opacity-25 md:opacity-0 md:w-[0%]"></span>
    </Link>
  );
}
