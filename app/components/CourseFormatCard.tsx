...
export interface CourseFormatCardProps {
...
export default function CourseFormatCard(props: CourseFormatCardProps) {
  return (
    <div className="rounded-2xl group border-red border-opacity-50 border shadow-sm flex flex-col relative p-4 justify-start items-center bg-white bg-opacity-50 backdrop-blur-sm">
      {props.icon}
