...
const Testimonial = (props: { name: string; content: string }) => {
  return (
    <div className="py-5 w-full md:w-[calc(100%-44px/2)] px-10 h-full mx-auto z-20">
...
export default function Testimonials() {
  return (
    <div className="relative mx-5 pb-3 md:px-[22px] rounded-2xl border-red border-opacity-50 border shadow-sm">
      {/* <svg
